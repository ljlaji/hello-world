...
{
	int i,nsat, nepoch;
	double ep[6] = { 2021, 6, 16, 4, 5, 0 }, rr[3] = { 0 }, pos[3] = { 0 }, enu[3] = { 0 };
	obs_t obss = {0};
	...
	char *infiles[3] = { "E:\\Project\\data\\20210616\\20210616-01\\gnsicm1_00000000.obs",
		"E:\\Project\\data\\20210616\\20210616-01\\B1167E.21O",
		"E:\\Project\\data\\20210616\\BRDC00IGS_R_20211670000_01D_MN.rnx" };//E:\\Project\\data\\20210616\\20210616-01\\gnsicm1_00000000.nav
	char *outfile = { "E:\\Project\\data\\20210616\\20210616-01\\result.pos" };
...
//	opt.ionoopt = IONOOPT_IFLC;//IONOOPT_IFLC
	...
	while (1)
	{
		...
		if (!RtkPos(&opt, &obst, &navt, &rtk)) continue;
		ifix++;
