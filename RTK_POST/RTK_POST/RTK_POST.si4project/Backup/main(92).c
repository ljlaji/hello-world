...
{
	int i,nsat, nepoch;
	double ep[6] = { 2021, 6, 16, 6, 43, 59 }, rr[3] = { 0 }, pos[3] = { 0 }, enu[3] = { 0 };
	obs_t obss = {0};
	...
	char *infiles[3] = { "E:\\Project\\data\\20210616\\20210616-06\\gnsicm1_00000005.obs",
		...
		"E:\\Project\\data\\20210616\\BRDC00IGS_R_20211670000_01D_MN.rnx" };
...
//	opt.ionoopt = IONOOPT_IFLC;//IONOOPT_IFLC
	...
	while (1)
	{
		...
		//if ((double)epochobs[0].time.time < 1623825839) continue;// 1621945783
		isol++;
