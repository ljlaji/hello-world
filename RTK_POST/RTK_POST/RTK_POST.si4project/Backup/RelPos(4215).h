...
typedef struct {
	uint8_t sat[MAXOBS];
	float64_t pos[MAXOBS][COORDIM];
	float64_t vel[MAXOBS][COORDIM];
	float64_t ele[MAXOBS];
	float64_t azi[MAXOBS];
	float64_t dis[MAXOBS];		 
	float64_t los[MAXOBS][COORDIM];//line of sight 
} T_SSAT;
...
typedef struct {        /* double-different type */
	...
	uint8_t ddnum;
	uint8_t sat[MAXOBS];
	float64_t ddL[MAXOBS];
	float64_t ddP[MAXOBS];
	float64_t triddL[MAXOBS];
	float64_t triddP[MAXOBS];
	float64_t ddmat[MAXOBS][COORDIM];
